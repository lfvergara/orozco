...
<div class="col-md-6">
  <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
     <div   class="section-14-box wow fadeIn <?php if(!has_post_thumbnail()) { echo "no-image"; } ?>">
             <div class="date" ><?php echo esc_html(get_the_date('d')) ?> - <span><?php echo esc_html( get_the_date('M')) ?> </span><br><span><?php echo esc_html( get_the_date('Y')) ?></span></div>
             <?php 
