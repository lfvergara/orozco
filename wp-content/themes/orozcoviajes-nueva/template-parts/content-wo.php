...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-6 col-sm-6 col-xs-12 product-list'); $_product = wc_get_product( get_the_ID() ); ?>>
             ...
             <?php if(has_post_thumbnail()):
               ...
               ?>
                <a href="<?php the_permalink(); ?>">
                  <img src="<?php echo esc_url($image_url[0]); ?>" width="100%" class="imagen-producto-tienda img-responsive wow fadeIn" alt="image">
                </a>
              <?php endif; ?>
