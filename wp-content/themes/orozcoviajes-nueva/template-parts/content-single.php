...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="section-14-box wow fadeIn <?php if(!has_post_thumbnail() || $hide_show_feature_image=='hide') { echo'no-image'; }?>">
         <div class="date"><span><?php echo  esc_html( get_the_date('d')); ?> - <?php echo esc_html( get_the_date('M') ); ?><br><?php echo esc_html( get_the_date('Y') ); ?></span></div>
              ...
              <div class="post-des">
                <?php the_content(); 
                    wp_link_pages( array(
                        'before' => '<div class="page-links">' . esc_html__( 'Páginas:','quality-construction' ),
                        'after'  => '</div>',
                      ) );
                ?>
              </div>
                  ...
                  <?php
                    edit_post_link(
                      sprintf(
                        ...
                        esc_html__( 'Editar %s','quality-construction'),
