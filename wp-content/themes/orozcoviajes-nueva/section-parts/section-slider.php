                            ...
                            while ($quality_construction_home_slider_section_query->have_posts()) {
                                ...
                                <div class="item <?php if ($i == 0) {
                                    ...
                                    <div class="carousel-caption">
                                        <h1 class="wow slideInLeft color-white text-left"><?php the_title(); ?></h1>
                                        <h3 class="wow slideInRight color-white text-left"><?= strtoupper(strip_tags(get_the_content())); ?></h3>
                                        <?php
                                        if (!empty($quality_construction_get_started_text)) {
                                            ?>
                                            <a href="<?php echo esc_url($quality_construction_get_started_text_link); ?>" class="btn btn-primary wow bounceInUp pull-left">
