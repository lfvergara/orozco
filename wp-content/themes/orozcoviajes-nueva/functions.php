...
function quality_construction_scripts()
{
    ...
    /*Bootstrap*/
    wp_enqueue_style('bootstrap', 'https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css', array(), '4.5.1');
    ...
    wp_enqueue_script('modernizr', get_template_directory_uri() . '/assets/js/modernizr.custom.js', array('jquery'), '20151215', true);

    wp_enqueue_script('touchefects', get_template_directory_uri() . '/assets/js/toucheffects.js', array('jquery'), '20151215', true);

//    wp_enqueue_script('jquery-pablo', get_template_directory_uri() . '/assets/js/jquery.js', array('jquery'), '20151215', true);

    wp_enqueue_script('bootstrap', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array('jquery'), '20151215', true);

    wp_enqueue_script('easing', get_template_directory_uri() . '/assets/js/jquery.easing.min.js', array('jquery'), '20151215', true);
    ...
    wp_enqueue_script('owlcarousel', get_template_directory_uri() . '/assets/owlcarousel/owl.carousel.min.js', array('jquery'), '20151215', true);
