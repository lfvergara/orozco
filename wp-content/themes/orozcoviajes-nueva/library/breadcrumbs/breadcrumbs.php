...
class Breadcrumb_Trail {
	...
	protected function set_labels() {
		...
		$defaults = array(
			'browse'              => esc_html__( 'Vistazo','quality-construction'),
			'aria_label'          => esc_attr_x( 'Breadcrumbs', 'breadcrumbs aria label','quality-construction'),
			'home'                => esc_html__( 'Inicio','quality-construction'),
			'error_404'           => esc_html__( 'Error 404: página no encontrada','quality-construction'),
			'archives'            => esc_html__( 'Archivos','quality-construction'),
			// Translators: %s is the search query. The HTML entities are opening and closing curly quotes.
			'search'              => esc_html__( 'Resultados de búsqueda para &#8220;%s&#8221;','quality-construction'),
			// Translators: %s is the page number.
			'paged'               => esc_html__( 'Página %s','quality-construction'),
			// Translators: Minute archive title. %s is the minute time format.
			'archive_minute'      => esc_html__( 'Minuto %s','quality-construction'),
			// Translators: Weekly archive title. %s is the week date format.
			'archive_week'        => esc_html__( 'Semana %s','quality-construction'),
