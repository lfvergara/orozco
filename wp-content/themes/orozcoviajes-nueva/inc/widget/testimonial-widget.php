    ...
    class Quality_Construction_Testimonial_Widget extends WP_Widget
    {
        ...
        public function __construct()
        {
            parent::__construct(
                ...
                esc_html__('Widget Testimonios', 'quality-construction'),
        ...
        public function widget($args, $instance)
        {
            ...
            if (!empty($instance)) {
                ...
                if ($count > 0) {
                    ?>
                    <section id="section8" class="section-8 section-margine" style="background: url(<?php echo($bgimage); ?>) no-repeat center;">
                        <div class="container">
                            <div class="row">
